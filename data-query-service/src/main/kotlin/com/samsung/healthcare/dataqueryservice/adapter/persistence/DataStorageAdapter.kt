...
class DataStorageAdapter(
    ...
    override fun executeQuery(projectId: String, sql: String): QueryDataResult {
        val data = mutableListOf<Map<String, Any?>>()
        val columns = mutableListOf<String>()

        dbConnection(projectId).use { conn ->
    ...
    private fun dbConnection(projectId: String): Connection {
        val properties = Properties()
        properties.setProperty("user", config.trino.user)
